...
two procedures and elsewhere in this guide is the Ant
build tool, which is included in the {TechnologyShortName} TCK bundle.
...
[source,subs="attributes"]
----
ant -Dtests=api/javasoft/sqe/tests/javax/mail/Address run
----
...
[source,subs="attributes"]
----
ant -Dtests=api/javasoft/sqe/tests/javax/mail/internet run
----
...
[source,oac_no_warn]
----
ant -DpriorStatus="fail,error" run
----
